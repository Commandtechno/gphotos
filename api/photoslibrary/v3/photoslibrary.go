...
// ListMediaItemsResponse: List of media items that match the search
// parameters.
...
// List: Lists all media items from a user's Google Photos library.
...
// that were not created by this app. This
// field is ignored if the PhotoslibraryReadonlyAppcreateddataScope scope
// is used.
func (c *MediaItemsListCall) ExcludeNonAppCreatedData() *MediaItemsListCall {
	c.urlParams_.Set("excludeNonAppCreatedData", "true")
	return c
}
...
func (c *MediaItemsListCall) Do(opts ...googleapi.CallOption) (*ListMediaItemsResponse, error) {
	...
	//       "description": "If set, the results exclude media items that were not created by this app. This\nfield is ignored if the PhotoslibraryReadonlyAppcreateddataScope scope is used.",
	//       "location": "query",
	//       "type": "boolean"
	//     },
	//     "pageSize": {
